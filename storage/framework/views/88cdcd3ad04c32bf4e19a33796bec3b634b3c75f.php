...
<div class="row row-dd row-dd-relationship">
    <div class="col-xs-2">
        ...
        <strong><?php echo e(__('voyager::database.type')); ?>:</strong> <span><?php echo e(__('voyager::database.relationship.relationship')); ?></span><br/>
        <strong><?php echo e(__('voyager::generic.required')); ?>:</strong>
        <input type="checkbox" value="1" name="field_required_<?php echo e($relationship['field']); ?>" <?php if(!empty($relationship->required)): ?>checked="checked"<?php endif; ?>>
        <div class="handler voyager-handle"></div>
    ...
    <div class="col-md-12 voyager-relationship-details">
        ...
        <div class="relationship_details_content margin_top">
            ...
            <div class="belongsToShow belongsToManyShow relationship_details_content" style="flex:1">
                <label class="relationship_key"><?php echo e(__('voyager::database.relationship.store_the')); ?> <span class="label_table_name"></span></label>
                <select name="relationship_key_<?php echo e($relationship['field']); ?>" class="rowDrop select2 relationship_key" data-table="<?php if(isset($relationshipDetails->table)): ?><?php echo e($relationshipDetails->table); ?><?php endif; ?>" data-selected="<?php if(isset($relationshipDetails->key)): ?><?php echo e($relationshipDetails->key); ?><?php endif; ?>">
            ...
            <div class="hasOneShow hasManyShow relationship_details_content" style="flex:1">
                <label class="relationship_key"><?php echo e(__('voyager::database.relationship.store_the')); ?>

                    <span><?php echo e(\Illuminate\Support\Str::singular(ucfirst($table))); ?></span>
                </label>
                <select name="relationship_key_<?php echo e($relationship['field']); ?>" class="select2 relationship_key">
                    <?php $__currentLoopData = $fieldOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($data['field']); ?>" <?php if($relationshipDetails->key == $data['field']): ?> selected="selected" <?php endif; ?>><?php echo e($data['field']); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <br>
...
<?php /**PATH /var/www/vhosts/diz-ain.kz/httpdocs/vendor/tcg/voyager/src/../resources/views/tools/bread/relationship-partial.blade.php ENDPATH**/ ?>