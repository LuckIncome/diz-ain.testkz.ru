<ul class="sidebar__menu">
  ...
  <li class="sidebar__menu-drop" :class="{'sidebar__menu-show' : isSidebarMenuDrop}">
    <button @click="sidebarMenuDrop"><?php echo e($item->title); ?> <div class="arrow"></div></button>
    <ul>
...
<?php /**PATH /var/www/vhosts/diz-ain.kz/httpdocs/resources/views/vendor/voyager/menu/sidebar_menu.blade.php ENDPATH**/ ?>