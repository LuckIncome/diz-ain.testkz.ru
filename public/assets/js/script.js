var vue = new Vue({
    ...
    methods: {
        ...
        modalThanks() {
            this.isWrapper = this.isModalThanks = true
        },
        ...
        toggleWrapper() {
            ...
            this.isWrapper = this.isModalThanks = this.isModalAboutVideo = this.isModalOrder = this.isModalLeaveFeedback = this.isModalReviews = this.isModalContactUs = this.isSidebar = false
            this.scrollBlock()
